...
class ValidationService {
    ...
    /**
     * Valide le schéma d'un projet JSON exporté/importé (contrôles basiques)
     * @param {Object} data - Le JSON du projet
     ...
     * @returns {Object} { ok: boolean, missing: Array<string>, found: Array<string> } or { ok:false, error: string }
     */
