...
/**
 * Compute volumes map without cache. If sessionOverride is provided, try to compute volumes
 * using only seances for that session (StorageService or filtering allSeances).
 */
