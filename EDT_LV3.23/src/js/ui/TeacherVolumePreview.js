...
async function computeAnnualReferenceAndToleranceUncached() {
    ...
    try {
        ...
        if (typeof currentSessionName === 'string' && currentSessionName.toLowerCase().includes('automne') || (typeof currentSessionName === 'string' && currentSessionName.toLowerCase().includes('autumn'))) {
    ...
    try {
        if (typeof VolumeService !== 'undefined' && VolumeService && typeof VolumeService.calculateAllVolumes === 'function') {
            ...
            if (sessionOverride) {
                try {
                    if (StorageService && typeof StorageService.loadSessionData === 'function') {
                        const loaded = StorageService.loadSessionData(sessionOverride) || {};
