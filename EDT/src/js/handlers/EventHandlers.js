/**
 * Gestionnaire global des événements DOM
...
class EventHandlers {
    ...
    ouvrirFormulairePourModifier(id) {
        ...
        console.log('Édition de la séance', id);
    }
    ...
    attribuerSeanceDirectement(jour, creneau) {
        // TODO: Implémenter l'attribution rapide
        console.log('Attribution rapide', jour, creneau);
    }
